...
| FR-REC-001..004 | candidate profile, recommendation run/items with skill/role/location/work-mode/interview/freshness evidence and append-only attributed feedback | <code>test_product_recommendations_contract.py</code>, <code>test_recommendation_feedback_contract.py</code> | Implemented |
