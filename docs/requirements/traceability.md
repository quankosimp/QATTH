...
| FR-ADMIN-001..005 | masked/audited resource and user search, model config, durable idempotent background-job retry, source/moderation, credit dual-control | <code>test_product_admin_ops_contract.py</code>, <code>test_admin_job_retry_outbox.py</code>, <code>test_product_billing_contract.py</code> | Implemented |
